    ...
    $scope.updateEmployee = function () {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          var temp = $scope.employee;
          var idCV = Number(temp.chucVu);
          $scope.employee.chucVu = idCV;

          axios
            .put("http://localhost:8080/employee/update", temp)
            .then((res) => {
