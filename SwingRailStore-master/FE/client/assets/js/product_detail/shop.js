clientApp.controller("shopControllers", function ($scope, $http, $window) {
  $window.scrollTo(0, 0);
  ...
  $scope.loadProductDetails = () => {
    $http
      .get("http://localhost:8080/product-detail/get-all?size=1000&page=0")
      .then(function (response) {
        ...
        if (
          $scope.listBrandChoose.length == 0 &&
          $scope.listTypeChoose.length == 0 &&
          $scope.listColorChoose.length == 0 &&
          $scope.listSizeChoose.length == 0
        ) {
  ...
  rangeSlider.slider({
    slide: function (event, ui) {
      amount.val(
        $scope.formatToVND(ui.values[0]) +
          " - " +
          $scope.formatToVND(ui.values[1])
      );
      $scope.loadProductDetails();
    },
  });
  ...
  $scope.loadData = () => {
    $http
      .get("http://localhost:8080/product/get-quantity-of-product-by-brand")
      .then(function (response) {
    ...
    $http
      .get("http://localhost:8080/product/get-quantity-of-product-by-color")
      .then(function (response) {
    ...
    $http
      .get("http://localhost:8080/product/get-quantity-of-product-by-size")
      .then(function (response) {
    ...
    $http
      .get("http://localhost:8080/product/get-quantity-of-product-by-type")
      .then(function (response) {
