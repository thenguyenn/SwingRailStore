      ...
      if ($scope.bill === null) {
        ...
        setTimeout(() => {
          axios
            ...
            .catch(function (error) {});
          $scope.addBill(
            `Hóa đơn ${$scope.bill.ma} đã được xác nhận thành công`
          );
          $scope.loadBill();
        }, 100);
      }
      ...
      if ($scope.bill === null) {
        ...
        setTimeout(() => {
          axios
            ...
            .catch(function (error) {});
          $scope.addBill(
            `Hóa đơn ${$scope.bill.ma} đã được giao cho bên vận chuyển.`
          );
          $scope.loadBill();
        }, 100);
      }
      ...
      if ($scope.bill === null) {
        ...
        setTimeout(() => {
          axios
            ...
            .catch(function (error) {});
          $scope.addBill(
            `Hóa đơn ${$scope.bill.ma} đã được hoàn lại hàng thành công`
          );
          $scope.loadBill();
        }, 100);
      }
    ...
    $scope.refundSingleBill = () => {
      ...
      if ($scope.bill === null) {
        ...
        setTimeout(() => {
          $scope.loadBill();
          $scope.addBill(
            `Hóa đơn ${$scope.bill.ma} đã được hoàn lại thành công`
          );
        }, 100);
      }
    };
    ...
    $scope.confirmPayment = () => {
      ...
      axios
        ...
        .then(function (response) {
          ...
          setTimeout(() => {
            $scope.addBill(
              `Hóa đơn ${$scope.bill.ma} đã thanh toán thành công.`
            );
            $scope.loadBill();
          }, 100);
        })
