clientApp.controller("homeController", function ($scope, $http) {
  // entity
  ...
  $scope.loadData = () => {
    ...
    $http
      .get("http://localhost:8080/product-detail/get-top-product-best-seller")
      .then((response) => {
    ...
    $http
      .get("http://localhost:8080/product-detail/get-product-detail-with-sale")
      .then((response) => {
